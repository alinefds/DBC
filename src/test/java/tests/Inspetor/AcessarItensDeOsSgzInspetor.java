...
public class AcessarItensDeOsSgzInspetor {
    ...
    public void setUP() {
        ...
        driver.findElement(By.id("j_username")).sendKeys("MIBT01");
        ...
        String ScreenshotArquivo = "C:\\MAGNA\\PROJETOS\\Sprint#9\\Reestruturação Grupos de Segurança\\ITENS DE OS\\Inspetor\\" + Generator.dataHoraParaArquivo() + test.getMethodName() + ".png";
        ...
        assertEquals("Claudionor Dantas de Almeida", mensagem);
