...
public class testStatusEMANDItemDeOsConcluirAdmin {
    ...
    @Test
    public void testStatusEMANDItemDeOsConcluirAdmin() {
        ...
        WebElement OsConcluir = driver.findElement(By.cssSelector("#mb64e0e96-rb"));
        assertTrue(OsConcluir.isSelected());
        ...
        WebElement DialogoConfirmarAcao = driver.findElement(By.xpath("//*[@id='ms_wowf06-dialog_inner']"));
        ScreenshotArquivo = "C:\\Users\\Cecília\\Documents\\ITENS DE OS\\Administrador do Sistema\\" + Generator.dataHoraParaArquivo() + test.getMethodName() + ".png";
        Screenshot.tirar(driver, ScreenshotArquivo);
