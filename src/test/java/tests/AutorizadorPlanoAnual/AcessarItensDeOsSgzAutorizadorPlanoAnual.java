package tests.AutorizadorPlanoAnual;
...
public class AcessarItensDeOsSgzAutorizadorPlanoAnual {
    ...
    public void testAutorizadorPlanoAnualNaoTemAcessoItensDeOsSGZ() {
        ...
        driver.findElement(By.id("j_username")).sendKeys("D507275");
        ...
        String ScreenshotArquivo = "C:\\MAGNA\\PROJETOS\\Sprint#9\\Reestruturação Grupos de Segurança\\ITENS DE OS\\Autorizador Plano Anual\\" + Generator.dataHoraParaArquivo() + test.getMethodName() + ".png";
        ...
        assertEquals("Gilberto Torrigo", mensagem);

        //Acessar o menu Principal "Ordens de Serviço"
        WebElement ClickMenuOs = driver.findElement(By.linkText("Ordens de Serviço"));
        ClickMenuOs.click();

        ScreenshotArquivo = "C:\\MAGNA\\PROJETOS\\Sprint#9\\Reestruturação Grupos de Segurança\\ITENS DE OS\\Autorizador Plano Anual\\" + Generator.dataHoraParaArquivo() + test.getMethodName() + ".png";
        Screenshot.tirar(driver, ScreenshotArquivo);
